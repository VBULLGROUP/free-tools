...
export const SITE_NAME = "Free Tools"
export const SITE_DESCRIPTION = "Logistics, Warehouse online free tools"
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://saas-stack.startupstudio.dev"
export const GITHUB_REPO_URL = "https://github.com/VBULLGROUP/free-tools"
